...
public class TravelTimesForTrip implements Serializable {
    ...
    @JoinTable(name = "travel_times_for_trip_to_travel_times_for_path",
            joinColumns = {
                    @JoinColumn(name = "for_path_id", table = "travel_times_for_stop_paths", referencedColumnName = "id")
            },
            inverseJoinColumns = {
                    @JoinColumn(name = "for_trip_id", table = "travel_times_for_trips", referencedColumnName = "id")
            })

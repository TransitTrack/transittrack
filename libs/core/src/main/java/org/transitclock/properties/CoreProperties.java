...
public class CoreProperties {
    ...
    private int allowableNumberOfBadMatches = 2;
    ...
    private int maxPredictionTimeForDbSecs = 1800;
    ...
    private int allowableEarlyForLayoverSeconds = 3600;
    ...
    private int allowableEarlySeconds = 900;
    ...
    private int allowableLateSeconds = 5400;
    ...
    private int allowableEarlySecondsForInitialMatching = 600;
    ...
    private int allowableLateSecondsForInitialMatching = 1200;
    ...
    private int allowableEarlyTimeForEarlyDepartureSecs = 300;
    ...
    private int allowableEarlyDepartureTimeForLoggingEvent = 60;
    ...
    private int allowableLateDepartureTimeForLoggingEvent = 240;
    ...
    private int allowableLateAtTerminalForLoggingEvent = 60;
    ...
    private int defaultBreakTimeSec = 0;
    ...
    private int timeForDeterminingNoProgress = 480000;
    ...
    private int timeForDeterminingDelayedSecs = 240;
    ...
    private int matchHistoryMaxSize = 20;
    ...
    private int avlHistoryMaxSize = 20;
    ...
    private int maxLateCutoffPredsForNextTripsSecs = 2147483647;
    ...
    private int allowableBadAssignments = 0;
    ...
    private boolean agressiveBlockLoading = false;
    ...
    private int blockactiveForTimeBeforeSecs = 0;
    ...
    private int blockactiveForTimeAfterSecs = -1;
    ...
    private int maxDwellTime = 600000;
    ...
    public static class Frequency {
        ...
        private int minTravelTimeFilterValue = 0;
        ...
        private int maxTravelTimeFilterValue = 600000;
        ...
        private int minDwellTimeFilterValue = 0;
        ...
        private int maxDwellTimeFilterValue = 600000;
        ...
        private int cacheIncrementsForFrequencyService = 10800;
    }
